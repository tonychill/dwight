...
const footerNavigation = {
  ...
  social: [
    {
      name: "Facebook",
      href: "https://www.facebook.com/dwight.winston/",
      icon: (props: any) => (
    ...
    {
      name: "Instagram",
      href: "https://www.instagram.com/dwightwinston",
      icon: (props: any) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
          <path
            fillRule="evenodd"
    ...
    {
      name: "LinkedIn",
      href: "https://www.linkedin.com/in/dwight-winston-61839645",
      icon: (props: any) => (
        <svg
          fill="currentColor"
          height="24px"
    ...
    {
      name: "YouTube",
      href: "https://www.youtube.com/user/dwightwinston",
      icon: (props: any) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
          <path
            fillRule="evenodd"
  ...
  return (
    <footer className="mt-32 sm:mt-40" aria-labelledby="footer-heading">
      ...
      <div className="mx-auto max-w-7xl px-6 pb-8 lg:px-8">
        <div className="hidden border-t border-gray-900/10 pt-20 _xl:grid _xl:grid-cols-3 xl:gap-8">
        ...
        <div className="mt-16 border-t border-gray-900/10 pt-8 sm:mt-20 md:flex md:items-center md:justify-between lg:mt-24">
          ...
          <p className="mt-8 text-xs leading-5 text-gray-500 md:order-1 md:mt-0">
            &copy; 2024 D Winston Media, Inc. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
