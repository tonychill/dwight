...
export const caseStudy = {
  client: 'FamilyFunding',
  title: 'Sometimes it comes down to the food',
  description:
    'Providing your team with the best eating accomidations sometimes is the best thing you can do to make a projection top notch.',
  summary: [
    'Providing your team with the best eating accomidations sometimes is the best thing you can do to make a projection top notch.',
